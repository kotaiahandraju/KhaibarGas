...
public class CylindermasterBean 
{
protected int id   = 0;
...
public void setCylendersstatus(String cylendersstatus) {
	this.cylendersstatus = cylendersstatus;
}
...
public void setCylinderid(final String cylinderid)
{
