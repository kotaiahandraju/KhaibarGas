...
import com.aurospaces.neighbourhood.db.basedao.BaseCTariffHistoryDao;




@Repository(value = "cTariffHistoryDao")
public class CTariffHistoryDao extends BaseCTariffHistoryDao
{
	@Autowired
