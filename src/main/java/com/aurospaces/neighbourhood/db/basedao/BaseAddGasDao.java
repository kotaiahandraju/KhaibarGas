...
public class BaseAddGasDao{
	...
	public final String INSERT_SQL = "INSERT INTO addgas( created_time, updated_time, fillingStationId,gasInKgs,closedgas,fillingstationname,lponumber) values (?,?, ?, ?, ?,?,?)"; 
...
ps.setString(7, addGasBean.getLponumber());
