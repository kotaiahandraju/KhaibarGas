...
function displayTable(listOrders) {
	...
	var tableHead = '<table id="example" class="table table-striped table-bordered datatables">'
		+ '<thead><tr><th>Date</th><th>Fillingstation Name</th><th>Gas</th><th>Gas InKgs</th></tr></thead><tbody></tbody><tfoot><tr><th colspan="3" style="text-align:center;"  >Total</th><th id="totalgas"></th></tr><tfoot></table>';
