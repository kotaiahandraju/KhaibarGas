...
<%-- 				        		<form:input path="customerType" class="form-control "  onkeydown="removeBorder(this.id)"/> --%>
					...
					<div class="col-md-3">
						<div class="form-group">
							...
							<div class="col-md-7">
				        		<form:select path="items"  class="form-control "  onfocus="removeBorder(this.id)">
				        		<form:option value="">-- select Cylinder --</form:option>
...
function displayTable(listOrders) {
	...
	var tableHead = '<table id="example" class="table table-striped table-bordered datatables">'
		+ '<thead><tr><th>Date</th><th>Fillingstation Name</th><th>Gas Type</th><th>Gas InKgs</th></tr></thead><tbody></tbody><tfoot><tr><th colspan="3" style="text-align:center;"  >Total</th><th id="totalgas"></th></tr><tfoot></table>';
$('#tableId').html(tableHead);
	var totalgas =0.00;
	$.each(listOrders,function(i, orderObj) {
	
	totalgas = totalgas+parseInt(orderObj.totalgas);
	var tblRow = "<tr >"
		+ "<td class='impFiled' title='"+orderObj.cdate+"'>" + orderObj.cdate + "</td>"
		+ "<td class='impFiled' title='"+orderObj.stationname+"'>" + orderObj.stationname + "</td>"
		+ "<td class='impFiled' title='"+orderObj.gasType+"'>" + orderObj.gasType + "</td>"
		+ "<td title='"+orderObj.totalgas+"'>" + orderObj.totalgas + "</td>"
		+ "</tr >";
