...
function displayTable(listOrders) {
	...
	$.each(listOrders,function(i, orderObj) {
		...
		var tblRow = "<tr >"
				+ "<td style='padding-left:24px;' title='"+orderObj.cylinderid+"'><input class='child' name='chkbox' type='checkbox' style='width: 21px;' value='"+orderObj.id+"' >"+ orderObj.cylinderid + "</td>"
