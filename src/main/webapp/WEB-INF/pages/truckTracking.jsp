            ...
            <div class="col-md-12 col-sm-12">
                <div class="panel panel-primary">
                    ...
                    <form:hidden path="id"/>
                    		...
                    		<div class="col-md-6">
                    			<div class="form-group">
                    				<label for="focusedinput" class="col-md-4 control-label">Out Date/In Date <span class="impColor">*</span></label>
								    <div class="col-md-6">
								    	<form:input path="outDate" value="" class="form-control validate onlyCharacters" placeholder="Out Date/In Date" />
                    		...
                    		<div class="col-md-6">
                    			<div class="form-group">
								    ...
								    <div class="col-md-6">
										<form:input path="ReadingKM" value="" class="form-control validate onlyCharacters" placeholder="Reading (KM)" />			                                
                    		...
                    		<div class="col-md-6">
                    			<div class="form-group">
								    ...
								    <div class="col-md-6">
								    	<form:input path="PetrolLevel" value="" class="form-control validate onlyCharacters" placeholder="Petrol Level" />
...
function displayTable(listOrders) {
	...
	var tableHead = '<table id="example" class="table table-striped table-bordered datatables">'
			+ '<thead><tr><th>Truck Number</th><th>Truck Status</th><th>Out Date/In Date</th><th>Location</th><th>Reading (KM)</th><th>Petrol Level</th><th>Driver Name</th><th>Status</th><th style="text-align: center;"></th></tr></thead><tbody></tbody></table>';
	...
	$.each(listOrders,function(i, orderObj) {
		...
		var tblRow = "<tr >"
				...
				+ "<td class='impFiled' title='"+orderObj.truckStatus+"'>"+ orderObj.truckStatus + "</td>"
